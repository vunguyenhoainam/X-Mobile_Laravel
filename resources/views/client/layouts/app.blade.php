        ...
        <div class="container">
            <div class="header__top">
                <h1 class="header-logo-pc">
                    <a href="{{ route('client.products.index') }}">X-Mobile</a>
                </h1>
                ...
                <a href="{{ route('client.cart.showCart') }}" class="header-cart">
                    <i class="far fa-shopping-cart icon-cart"></i>
                    <span class="notifi">{{ Session::has('cart') ? count(Session::get("cart")) : '0'}}</span>
                    <p>Giỏ hàng</p>
                </a>
            ...
            <!-- Categories -->
            @include('client.layouts.categories')
    ...
    <footer class="footer">
        <div class="container">
            ...
            <a href="#" class="pay">
                ...
                <img src="{{ asset('client/assets/images/pc/pay.jpg') }}" alt="">
            </a>
        </div>
    </footer>
